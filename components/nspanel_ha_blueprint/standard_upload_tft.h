...
namespace nspanel_ha_blueprint {
    ...
    /**
     * Constructs the TFT file URL based on branch, model, and base URL.
     * 
     ...
     */
    std::string construct_tft_url(const std::string& branch, const std::string& model, const std::string& baseUrl);
